...
class Signup extends React.Component {
  ...
  render() {
    ...
    // const { firstName, lastName, email, password, password2, error } = this.state;
    return (
...
const mapDispatchToProps = (dispatch) => {
  return {
    signup: (firstName, lastName, email, password, success, fail) => {
      dispatch(signup(firstName, lastName, email, password, success, fail));
    }
  }
};
